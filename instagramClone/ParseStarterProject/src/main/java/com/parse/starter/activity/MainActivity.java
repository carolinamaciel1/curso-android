    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                imagem.compress(Bitmap.CompressFormat.PNG, 15, stream);

                // Cria um array de bytes de imagem
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    "Erro ao postar sua imagem - Tente novamente" + e.getMessage(),
...
/*****************************************
 * Parse dashboard:
 * parse-dashboard --appId 1n5t4gR4M --masterKey Comp2016.1 --serverURL "http://instagram57.herokuapp.com/parse" --appName instagram57
 * */
